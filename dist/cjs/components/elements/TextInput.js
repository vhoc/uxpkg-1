...
var TextInput = function (_a) {
    ...
    var _j = (0, react_1.useState)(value), stateValue = _j[0], setStateValue = _j[1];
    ...
    return (react_1["default"].createElement(material_1.FormControl, { sx: {
        ...
        react_1["default"].createElement(MyInput, tslib_1.__assign({ id: id, autoComplete: autoComplete, autoFocus: autoFocus, classes: classes, defaultValue: defaultValue, error: error, name: name, onChange: onChange, placeholder: placeholder, fullWidth: fullWidth, multiline: multiline, readOnly: readOnly, required: required, rows: rows, sx: sx, type: type, value: value, startAdornment: icon && iconPosition === 'start' ?
                ...
                react_1["default"].createElement(material_1.InputAdornment, { position: iconPosition, onClick: stateValue ? endIconOnClick : undefined, style: {
                        cursor: stateValue ? 'pointer' : 'initial'
                    } },
                    react_1["default"].createElement(react_fontawesome_1.FontAwesomeIcon, { icon: stateValue ? pro_solid_svg_icons_1.faCircleXmark : icon, style: {
                            color: stateValue ? theme_1.colors.gray[70] : theme_1.colors.gray[30]
                        } }))
                :
                    null }, props))));
};
