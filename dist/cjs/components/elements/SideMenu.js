...
var SideMenu = function (_a) {
    var _b = _a.variant, variant = _b === void 0 ? 'primary' : _b, menuItems = _a.menuItems, onMouseEnter = _a.onMouseEnter, onMouseLeave = _a.onMouseLeave, style = _a.style, _c = _a.collapsed, collapsed = _c === void 0 ? true : _c, props = tslib_1.__rest(_a, ["variant", "menuItems", "onMouseEnter", "onMouseLeave", "style", "collapsed"]);
    ...
    return (react_1["default"].createElement("div", tslib_1.__assign({ style: tslib_1.__assign({ width: (collapsed && !keepExtended) ? 'fit-content' : '289px', minHeight: '100%', height: '100%', backgroundColor: theme_1.variants[selectedVariant].sideBarBgColor, paddingTop: '16px', paddingBottom: '16px', paddingLeft: '8px', paddingRight: '8px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between' }, style), 
        ...
        menuItems && menuItems.length >= 1 ?
            menuItems.map(function (item, index) {
                return (react_1["default"].createElement(SideMenuItem_1.SideMenuItem, { key: index, itemType: item.itemType, icon: item.icon, variant: item.variant, disabled: item.disabled, collapsed: collapsed, 
