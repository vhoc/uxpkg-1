...
var PickListHeading = function (_a) {
    var title = _a.title, dropDownItems = _a.dropDownItems, dropDownValue = _a.dropDownValue, style = _a.style, _b = _a.showDropDown, showDropDown = _b === void 0 ? true : _b, onChange = _a.onChange;
    return (react_1["default"].createElement("div", { style: tslib_1.__assign({ minWidth: 'fit-content', height: '32px', backgroundColor: theme_1.colors.gray[10], borderStyle: 'solid', borderWidth: '1px', borderColor: theme_1.colors.gray[20], borderTopLeftRadius: '4px', borderTopRightRadius: '4px', borderBottomLeftRadius: '0px', borderBottomRightRadius: '0px', paddingLeft: '16px', paddingRight: '8px', paddingTop: '4px', paddingBottom: '4px', display: 'flex', justifyContent: 'space-between' }, style) },
