...
var IconButton = function (_a) {
    ...
    var componentStyle = function (hover, active) { return (tslib_1.__assign({ 
        ...
        paddingLeft: '12px', paddingRight: '12px', fontFamily: theme_1.theme.font.buttonLabel.regular.fontFamily, fontSize: theme_1.sizes.iconButton[selectedSize].fontSize, borderRadius: '4px', cursor: disabled ? 'not-allowed' : 'pointer', border: 'none', 
