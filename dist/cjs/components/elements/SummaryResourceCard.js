    ...
    return (react_1["default"].createElement("div", tslib_1.__assign({ style: {
        ...
        react_1["default"].createElement("div", { style: { display: 'flex', gap: '12px' } },
            ...
            react_1["default"].createElement("div", { style: {
                ...
                react_1["default"].createElement(Typography_1["default"], { variant: 'title-regular' }, resourceName),
                react_1["default"].createElement(Typography_1["default"], { variant: 'body-regular' }, resourceType),
                react_1["default"].createElement(Typography_1["default"], { variant: 'caption-regular' }, "".concat(accountName, " / ").concat(region)))),
        react_1["default"].createElement("div", { style: { display: 'flex', justifyContent: 'flex-end', gap: '14px' } },
            ...
            react_1["default"].createElement("div", { style: {
                ...
                react_1["default"].createElement(IconButton_1["default"], { variant: 'gray', icon: pro_solid_svg_icons_1.faTrash, disabled: !isEditButtonEnabled, onClick: isEditButtonEnabled ? onClickEditButton : undefined }),
                react_1["default"].createElement(IconButton_1["default"], { variant: 'gray', icon: pro_solid_svg_icons_1.faPen, disabled: !isDeleteButtonEnabled, onClick: isDeleteButtonEnabled ? onClickDeleteButton : undefined })))));
};
exports["default"] = SummaryResourceCard;
