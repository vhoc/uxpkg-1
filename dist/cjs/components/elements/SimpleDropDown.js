...
var SimpleDropDown = function (_a) {
    ...
    var MySelect = (0, styles_1.styled)('select')(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, theme_1.theme.font.body.regular), { backgroundColor: 'transparent', paddingRight: '8px', '&:focus-visible': {
            outline: 'none'
        } }), style));
