...
export var ToggleCloudControl = function (_a) {
    ...
    return (React.createElement(ToggleButtonGroup, { value: value, exclusive: !multiSelect, onChange: onChange, "aria-label": ariaLabel, sx: {
        ...
        React.createElement(ToggleButton, { value: 'PRIVATE', "aria-label": 'PRIVATE', sx: {
                backgroundColor: colors.gray[10],
                paddingLeft: '14px',
                paddingRight: '14px',
                '&.Mui-selected': {
            ...
            React.createElement("img", { src: (value === 'PRIVATE' || (Array.isArray(value) && value.find(function (value) { return value === 'PRIVATE'; }))) ? imgPrivateColor : imgPrivateGray, alt: 'PRIVATE' }))));
};
