...
export var UserGroupBar = function (_a) {
    var type = _a.type, name = _a.name, leftIcon = _a.leftIcon, caption = _a.caption, _b = _a.selected, selected = _b === void 0 ? false : _b, _c = _a.assigned, assigned = _c === void 0 ? false : _c, addButtonOnClick = _a.addButtonOnClick, removeButtonOnClick = _a.removeButtonOnClick, style = _a.style, _d = _a.endButton, endButton = _d === void 0 ? true : _d, onClick = _a.onClick;
