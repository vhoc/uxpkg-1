...
export var PickListRowHeading = function (_a) {
    ...
    return (React.createElement("div", { style: __assign({ minWidth: 'fit-content', backgroundColor: '#f9fbfc', borderStyle: 'solid', borderWidth: '1px', borderColor: colors.gray[20], paddingLeft: '16px', paddingRight: '16px', paddingTop: '6px', paddingBottom: '6px', display: 'flex', justifyContent: 'space-between', gap: '16px' }, style) },
