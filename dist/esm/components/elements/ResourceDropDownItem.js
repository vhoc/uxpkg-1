...
export var ResourceDropDownItem = function (_a) {
    ...
    return (React.createElement("div", { style: __assign({ minWidth: '217px', width: '217px', backgroundColor: colors.white, paddingTop: '8px', paddingBottom: '8px', paddingLeft: '12px', paddingRight: '12px', display: 'flex', justifyContent: 'space-between', boxSizing: 'border-box' }, style) },
