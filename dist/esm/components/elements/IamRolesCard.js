        ...
        React.createElement("div", { style: { display: 'flex',
            ...
            React.createElement("div", null,
                React.createElement("div", { style: {
                    ...
                    React.createElement("div", { style: __assign(__assign({}, theme.font.body.semiBold), { whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', width: '400px' }) }, title),
                ...
                React.createElement("div", { style: {
                    ...
                    React.createElement("div", { style: __assign(__assign({}, theme.font.caption.regular), { width: '509px' }) }, description),
                    React.createElement(MyDiv, { style: __assign(__assign({}, theme.font.caption.regular), { width: '100%', height: '280px', paddingRight: '100px' }) }, children))),
            React.createElement("div", { style: {
                    display: 'flex',
                    justifyContent: 'space-between',
