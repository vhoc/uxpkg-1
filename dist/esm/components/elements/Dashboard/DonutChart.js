...
export var DonutChart = function (_a) {
    ...
    function renderStatistic(containerWidth, text, style) {
        var _a = measureTextWidth(text, style), textWidth = _a.width, textHeight = _a.height;
    ...
    return (React.createElement(Pie, { width: width, height: height, appendPadding: 10, data: data, color: color, angleField: 'value', colorField: 'type', radius: 1, innerRadius: 0.82, legend: false, label: {
            content: ""
        }, interactions: [
            {
