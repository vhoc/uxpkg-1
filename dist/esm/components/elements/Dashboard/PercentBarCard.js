...
export var PercentBarCard = function (_a) {
    ...
    return (React.createElement("div", { style: __assign({ minWidth: '666px', width: '666px', paddingTop: '20px', paddingRight: '24px', paddingLeft: '24px', paddingBottom: '18px', display: 'flex', flexDirection: 'column', borderStyle: 'solid', borderWidth: '1px', borderColor: 'rgb(216, 221, 228)', borderRadius: '4px', backgroundColor: colors.white }, style) },
