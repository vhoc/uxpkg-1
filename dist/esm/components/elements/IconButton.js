...
export var IconButton = function (_a) {
    ...
    var componentStyle = function (hover, active) { return (__assign({ 
        ...
        paddingLeft: '12px', paddingRight: '12px', fontFamily: theme.font.buttonLabel.regular.fontFamily, fontSize: sizes.iconButton[selectedSize].fontSize, borderRadius: '4px', cursor: disabled ? 'not-allowed' : 'pointer', border: 'none', outlineColor: focus ? variants[selectedVariant].buttonBgColor : 'transparent', outlineStyle: 'auto', outlineWidth: focus ? '2px' : '0px', display: 'flex', justifyContent: 'center', alignItems: 'center', zIndex: '500', position: 'relative' }, style)); };
