...
export var IconButton = function (_a) {
    var icon = _a.icon, _b = _a.size, size = _b === void 0 ? 'sm' : _b, _c = _a.variant, variant = _c === void 0 ? 'primary' : _c, _d = _a.disabled, disabled = _d === void 0 ? false : _d, onClick = _a.onClick, _e = _a.textColor, textColor = _e === void 0 ? colors.white : _e, width = _a.width, height = _a.height, badge = _a.badge, IconButtonProps = __rest(_a, ["icon", "size", "variant", "disabled", "onClick", "textColor", "width", "height", "badge"]);
