...
GCP_PUBSUB_TOPIC  
AZURE_PROVIDER_METADATA_TYPE
AZURE_SQL_SERVER_TYPE
AZURE_TENANT_TYPE
AZURE_SUBSCRIPTION_TYPE
AZURE_RESOURCE_GROUP_TYPE
AZURE_VM_TYPE
AZURE_SQL_SERVER_DATABASE_TYPE
AZURE_SQL_INSTANCE_POOL_TYPE
