...
export const DropDownButton = ({menuItems = [{ icon: faTimes, title: `No menus found` }], variant = 'primary', size = 'sm', disabled, hasDownArrow = true, ...DropDownButtonProps}: DropDownButtonProps) : JSX.Element => {
